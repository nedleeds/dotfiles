...
// ----------------------------
// --- arcane
const vec4 ELECTRIC_COLOR     = vec4(0.55, 0.25, 1.00, 1.0);
const vec4 TRAIL_COLOR_ACCENT = vec4(0.90, 0.60, 1.00, 1.0);

// --- green thunder
// const vec4 ELECTRIC_COLOR     = vec4(0.15, 0.65, 0.40, 1.0); // 딥 에메랄드 그린
// const vec4 TRAIL_COLOR_ACCENT = vec4(0.30, 0.75, 0.55, 1.0); // 서브 하이라이트
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    // 기존 0.35 → 딥 컬러에서는 과함
    vec3 coreRGB = mix(vec3(1.0), outerRGB, 0.15);
